...
urlpatterns = [
    ...
    url(r'^places/(?P<id>\d+)$', detail, name='place_detail'), #<-- name='place_detail' modelden return ettirdigimiz isim. Eger modelde Mahmut döndürseydik buraya da Mahmut yazmamız gerekirdi
    ...
    url(r'^places/(?P<place_id>\d+)/update-review/(?P<review_id>\d+)$', update_review, name='update_review'),
